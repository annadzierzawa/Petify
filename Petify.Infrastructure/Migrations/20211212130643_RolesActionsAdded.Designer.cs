...
namespace Petify.Infrastructure.Migrations
{
    ...
    [Migration("20211212130643_RolesActionsAdded")]
    partial class RolesActionsAdded
    {
            ...
            modelBuilder.Entity("Petify.Domain.Access.Action", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            Name = "ManageUsersAdvertisements"
                        });
                });
            ...
            modelBuilder.Entity("Petify.Domain.Advertisements.Advertisement", b =>
                {
                    ...
                    b.Property<int?>("CyclicalAssistanceFrequency")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Petify.Domain.Advertisements.Advertisement", b =>
                {
                    ...
                    b.HasOne("Petify.Domain.Access.User", "Owner")
